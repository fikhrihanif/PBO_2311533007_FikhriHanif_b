...
public class ServiceFrame extends JFrame {
	...
	public ServiceFrame() {
		...
		txtJenis.setBounds(165, 31, 303, 19);
		panel.add(txtJenis);
		...
		txtStatus.setBounds(165, 81, 303, 19);
		panel.add(txtStatus);
		...
		txtHarga.setBounds(165, 128, 303, 19);
		panel.add(txtHarga);
		...
		btnSave.setBounds(92, 193, 85, 40);
		panel.add(btnSave);
		...
		btnUpdate.setBounds(187, 193, 85, 40);
		panel.add(btnUpdate);
		...
		btnDelete.setBounds(288, 193, 85, 40);
		panel.add(btnDelete);
		...
		btnCancel.setBounds(383, 193, 85, 40);
		panel.add(btnCancel);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(10, 280, 530, 273);
